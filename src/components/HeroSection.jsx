    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
        ...
        <div className="mb-8 animate-fade-in" style={{ animationDelay: '0.2s' }}>
          <h2 className="text-4xl md:text-6xl font-urdu font-semibold text-primary-foreground mb-9 leading-relaxed">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in" style={{ animationDelay: '0.4s' }}>
          ...
          >
            <a href="#intru" className="font-urdu text-lg">تعارف جامعہ</a>
          </button>
          <button 
          ...
          >
            <a href="#contact-section" className="font-urdu text-lg">ہم سے رابطہ کریں</a>
          </button>
        </div>
